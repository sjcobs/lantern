...
Lantern talks to 1Password only through the [official CLI](https://developer.1password.com/docs/cli) (`op`) and the [official SDK](https://developer.1password.com/docs/sdks) (`@1password/sdk`). It is free, self-hosted, and [open source](LICENSE).
